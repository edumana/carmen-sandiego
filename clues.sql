...
WHERE c.region = 'Southern Europe' AND c.population < 50000;
...
-- TODO: Write SQL query here
SELECT * FROM countrylanguage d 
WHERE d.countrycode = 'VAT';
